...
public class PersonDAO {
    ...
    public void testMultipleUpdate() {
        ...
        for (Person person : people) {
            jdbcTemplate.update("INSERT INTO Person VALUES(?,?,?,?)", person.getAge(), person.getName(), person.getAge(),
                    person.getEmail());
        }
    ...
    public void testBatchUpdate() {
        ...
        System.out.println("Time with Batch Update" + (after - before));
    }
    ...
    private List<Person> create1000People() {
        ...
        for (int i = 0; i < 1000; i++) {
            people.add(new Person(1, "Name" + i, 30, "email" + i + "@gmail.ru"));
        }
